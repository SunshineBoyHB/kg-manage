...
@Configuration
@ComponentScan(basePackages = { "org.dml.backend.repository"})
@PropertySource(value = "classpath:metadeta.properties", encoding = "utf-8")
public class MetaInfoConfig {
	...
	public JedisPoolConfig redisPoolConfig(
			@Value("${redis.max.active}") int maxActive,
